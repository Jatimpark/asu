...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│   ${GREEN}[${COLBG1}01${GREEN}]${NC} • ADD VLESS      ${GREEN}[${COLBG1}03${GREEN}]${NC} • DELETE VLESS${NC}   $COLOR1│$NC"
echo -e " $COLOR1│   ${GREEN}[${COLBG1}02${GREEN}]${NC} • RENEW VLESS${NC}    ${GREEN}[${COLBG1}04${GREEN}]${NC} • USER ONLINE    $COLOR1│$NC"
