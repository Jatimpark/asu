...
echo -e "${GREEN}                SCRIPT ARYA BLITAR                    \E[0m"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo ""
...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/copy47/kon/main/ssh/proxy3.js"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/copy47/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
...
echo -e " $PURPLE│$NC   ${NC}[${GREEN}03${NC}]  USER ONLINE"
echo -e " $PURPLE│$NC   ${NC}[${GREEN}04${NC}]  ENABLE WS"
echo -e " $PURPLE│$NC   ${NC}[${GREEN}05${NC}]  DELETE SSH"
echo -e " $PURPLE│$NC   ${NC}[${GREEN}06${NC}]  RENEW SSH"
