...
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "     ${BICyan}[${GREEN}01${BICyan}] ${WT}SSHWS    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"    "     ${BICyan}[${GREEN}08${BICyan}] ${WT}BACKUP  ${NC} "
echo -e "     ${BICyan}[${GREEN}02${BICyan}] ${WT}VMESS    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "     ${BICyan}[${GREEN}09${BICyan}] ${WT}ADD-HOST  ${NC}"
echo -e "     ${BICyan}[${GREEN}03${BICyan}] ${WT}VLESS    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "     ${BICyan}[${GREEN}10${BICyan}] ${WT}CERT SSL     ${NC}"
echo -e "     ${BICyan}[${GREEN}04${BICyan}] ${WT}TROJANWS ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "     ${BICyan}[${GREEN}11${BICyan}]${WT} INSTAL UDP         "
echo -e "     ${BICyan}[${GREEN}05${BICyan}] ${WT}TROJANGO ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "     ${BICyan}[${GREEN}12${BICyan}] ${WT}UPDATE MENU ${NC}"
echo -e "     ${BICyan}[${GREEN}06${BICyan}] ${WT}TRIALL   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "     ${BICyan}[${GREEN}13${BICyan}] ${WT}INFO VPS ${NC}"
echo -e "     ${BICyan}[${GREEN}07${BICyan}] ${WT}SETTING  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "     ${BICyan}[${GREEN}14${BICyan}]${WT} KLUAR AREA  ${NC}"
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
